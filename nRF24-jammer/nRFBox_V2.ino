...
void about() {
  ...
  u8g2.drawStr(0, 15, "kawinphopkodsombat@gmail.com");
  u8g2.drawStr(0, 35, "youtube/minta1826");
  u8g2.drawStr(0, 55, "tiktok/minta1826");
  u8g2.sendBuffer();
}
...
void setup() {
  ...
  int16_t nameWidth = u8g2.getUTF8Width("nRF24-BOX"); 
  int16_t nameX = (128 - nameWidth) / 2;            
  u8g2.setCursor(nameX, 25);                      
  u8g2.print("nRF24-BOX");

  u8g2.setFont(u8g2_font_ncenB08_tr); 
  int16_t creditWidth = u8g2.getUTF8Width("by minta");
